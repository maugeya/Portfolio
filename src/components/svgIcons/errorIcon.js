...
const ErrorIcon = () => {
    return (
        <svg height="36px" version="1.1" viewBox="0 0 24 24" width="36px" xmlns="http://www.w3.org/2000/svg">
            <title/>
            <defs/>
            <g fill="none" fillRule="evenodd" id="Icons with numbers" stroke="none" strokeWidth="1">
                <g fill="#000000" id="Group" transform="translate(-96.000000, -432.000000)">
